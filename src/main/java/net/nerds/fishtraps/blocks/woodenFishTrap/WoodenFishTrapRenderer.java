...
public class WoodenFishTrapRenderer implements BlockEntityRenderer<WoodenFishTrapBlockEntity> {

    private final ItemStack fishBait;
    private final ItemRenderer itemRenderer;

    public WoodenFishTrapRenderer(BlockEntityRendererFactory.Context ctx) {
        this.itemRenderer = ctx.getItemRenderer();
        fishBait = new ItemStack(FishTrapsManager.FISH_BAIT);
    }

    @Override
    public void render(WoodenFishTrapBlockEntity blockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
