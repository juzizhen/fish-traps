...
public class WoodenFishTrapRenderer implements BlockEntityRenderer<WoodenFishTrapBlockEntity, WoodenFishTrapRenderer.FishTrapRenderState> {

    private final BlockEntityRendererProvider.Context context;
    private ItemStack fishBait;

    public WoodenFishTrapRenderer(BlockEntityRendererProvider.Context ctx) {
        this.context = ctx;
    }
    ...
    @Override
    public void extractRenderState(WoodenFishTrapBlockEntity blockEntity, FishTrapRenderState state, float tickDelta,
