...
public class IronFishTrapRenderer implements BlockEntityRenderer<IronFishTrapBlockEntity> {

    private final ItemStack fishBait;
    private final ItemRenderer itemRenderer;

    public IronFishTrapRenderer(BlockEntityRendererFactory.Context ctx) {
        this.itemRenderer = ctx.getItemRenderer();
        fishBait = new ItemStack(FishTrapsManager.FISH_BAIT);
    }

    @Override
    public void render(IronFishTrapBlockEntity blockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
