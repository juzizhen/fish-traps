...
public class DiamondFishTrapRenderer implements BlockEntityRenderer<DiamondFishTrapBlockEntity, DiamondFishTrapRenderer.FishTrapRenderState> {

    private final BlockEntityRendererProvider.Context context;
    private ItemStack fishBait;

    public DiamondFishTrapRenderer(BlockEntityRendererProvider.Context ctx) {
        this.context = ctx;
    }
    ...
    @Override
    public void extractRenderState(DiamondFishTrapBlockEntity blockEntity, FishTrapRenderState state, float tickDelta,
