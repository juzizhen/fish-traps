...
public class DiamondFishTrapGui extends HandledScreen<DiamondFishTrapContainer> {

    private static final Identifier TEXTURE = new Identifier(Fishtraps.MODID, "textures/gui/fish_trap_gui1.png");

    public DiamondFishTrapGui(DiamondFishTrapContainer container, PlayerInventory playerInventory, Text title) {
